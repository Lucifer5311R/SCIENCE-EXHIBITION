...
const App = () => {
    ...
    const blockData = [
        { id: 'internal', title: "Internal Projects", short: "INTERNAL", desc: "A dedicated area showcasing intra-collegiate projects, student research, and internal technological innovations.", angle: 225 },
        { id: 'external', title: "External Innovations", short: "EXTERNAL", desc: "Guest exhibits featuring cutting-edge prototypes, projects, and ideas from visiting academic institutions.", angle: 315 },
        { id: 'industrial', title: "Industrial Partners", short: "INDUSTRY", desc: "Professional demonstrations highlighting real-world applications and future technologies brought by our corporate partners.", angle: 45 },
        { id: 'workshop', title: "AI Tools Workshop", short: "WORKSHOP", desc: "Workshop on Essential AI Tools.\n\nTopics include:\n• Practical AI Applications\n• Prompt Engineering & Automation\n• Integrating AI into Modern Workflows", angle: 135 }
    ].map((info) => {
        ...
        return {
            ...
            x: islandCenter.x + 90 * Math.cos(rad),
            y: islandCenter.y + 90 * Math.sin(rad)
        };
    });
            ...
            <div className="relative flex-1 overflow-hidden touch-none bg-white">
                ...
                >
                    ...
                    <g>
                        ...
                        {/* Interactive Exhibition Blocks */}
                        {blockData.map(block => (
                            <g
                                key={block.id}
                                className="cursor-pointer group"
                                onClick={() => setSelectedStall(block)}
                            ...
                            >
                                <rect
                                    ...
                                    strokeWidth="2"
                                />
                                <text x="35" y="17" textAnchor="middle" className="text-[8px] fill-white font-black select-none uppercase tracking-wider">
                                    {block.short}
                                </text>
                            </g>
                        ))}
                ...
                <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end pointer-events-none">
                    <div className="bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-slate-200 pointer-events-auto w-48">
                        ...
                        <div className="flex flex-col gap-2.5">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-bold text-slate-700">Exhibition Hubs</span>
                            </div>
                            <div className="flex items-center gap-3">
                    ...
                    <div className="bg-slate-900 text-white px-4 py-2 rounded-xl shadow-lg flex items-center gap-2 pointer-events-auto">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-wider">Tap Hubs for Details</span>
                    </div>
                </div>
                        ...
                        <div className="bg-white w-full max-w-sm rounded-[2rem] shadow-2xl overflow-hidden animate-in zoom-in duration-200">
                            <div className="bg-blue-600 p-6 text-white relative">
                                <div className="flex items-center gap-2 opacity-80 text-[9px] font-black uppercase mb-1 tracking-widest">
                                    <MapPin className="w-3 h-3" /> {selectedStall.id.toUpperCase()} HUB
                                </div>
                            ...
                            <div className="p-6">
                                <p className="text-slate-600 text-sm leading-relaxed font-medium mb-6 whitespace-pre-line">
